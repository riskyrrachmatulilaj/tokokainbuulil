<x-filament-panels::page>
    ...
    <x-filament::section icon="heroicon-o-funnel">
        <x-slot name="heading">
            Filter Laporan Piutang Pelanggan
        </x-slot>
        <x-slot name="description">
            Pilih jenis laporan, rentang tanggal, dan pelanggan/debitur untuk menyaring data.
        </x-slot>
    ...
    @if ($this->results)
        @php
            $type = $this->data['type'] ?? 'receivable_list';
            $columns = \App\Exports\ReceivableReportExport::columnsFor($type);
            ...
            <div class="report-summary-grid">
                ...
                @if ($totalNominal > 0)
                    <div class="report-metric-card">
                        ...
                        <div>
                            <div class="report-metric-label">Total Nominal Piutang</div>
                ...
                @if ($totalPaid > 0)
                    <div class="report-metric-card">
                        ...
                        <div>
                            <div class="report-metric-label">Sudah Diterima</div>
                ...
                @if ($totalRemaining > 0)
                    <div class="report-metric-card">
                        ...
                        <div>
                            <div class="report-metric-label">Sisa Piutang Pelanggan</div>
                    ...
                    <table class="report-table">
                        ...
                        <tbody>
                            @forelse ($results as $row)
                                <tr>
                                    @foreach (\App\Exports\ReceivableReportExport::valuesFor($type, $row) as $index => $value)
                                        @php
