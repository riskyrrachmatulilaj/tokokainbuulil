<x-filament-panels::page>
    ...
    @if ($this->result)
        <div class="mt-6">
            <x-filament::section>
                <x-slot name="heading">
                    Hasil Pembayaran Kolektif Piutang
                </x-slot>
                ...
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                    <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/5">
                        <div class="text-sm text-gray-500 dark:text-gray-400">Debitur</div>
                        <div class="mt-1 font-semibold">{{ $this->result['collectivePayment']['party']['name'] }}</div>
                    </div>
                    <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/5">
                        <div class="text-sm text-gray-500 dark:text-gray-400">Total Diterima</div>
                    ...
                    <table class="w-full text-left text-sm">
                        <thead>
                            <tr class="border-b dark:border-white/10">
                                ...
                                <th class="px-3 py-2 font-semibold">Sisa Piutang</th>
