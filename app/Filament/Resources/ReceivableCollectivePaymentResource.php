...
use App\Filament\Resources\ReceivableCollectivePaymentResource\Pages;
use App\Filament\Resources\ReceivableCollectivePaymentResource\RelationManagers\HistoryRelationManager;
...
class ReceivableCollectivePaymentResource extends Resource
{
    protected static ?string $model = ReceivableCollectivePayment::class;

    protected static string | \BackedEnum | null $navigationIcon = 'heroicon-o-arrow-right-circle';

    protected static string | \UnitEnum | null $navigationGroup = 'Transaksi Piutang';

    protected static ?string $navigationLabel = 'Laporan Pembayaran Kolektif Piutang';

    protected static ?string $modelLabel = 'Laporan Pembayaran Kolektif Piutang';

    protected static ?string $pluralModelLabel = 'Laporan Pembayaran Kolektif Piutang';
    ...
    {
        return [
            'index' => Pages\ListReceivableCollectivePayments::route('/'),
            'view' => Pages\ViewReceivableCollectivePayment::route('/{record}'),
        ];
    }
}
