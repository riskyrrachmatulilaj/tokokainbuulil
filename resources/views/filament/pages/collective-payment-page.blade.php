<x-filament-panels::page>
    <x-filament::section icon="heroicon-o-banknotes">
        <x-slot name="heading">
            Form Pembayaran Kolektif Hutang
        </x-slot>
        <x-slot name="description">
            Pembayaran akan dialokasikan otomatis ke nota hutang tertua secara FIFO (First In, First Out).
        </x-slot>
            ...
            <x-filament::section icon="heroicon-o-receipt-percent">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="flex items-center gap-3.5 p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
                        ...
                        <div>
                            <div class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Supplier</div>
                            <div class="text-sm font-bold text-slate-900 dark:text-white">{{ $this->result['collectivePayment']['customer']['name'] }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3.5 p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
                        ...
                        <div>
                            <div class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Dibayar</div>
                    ...
                    <table class="w-full text-left text-sm">
                        <thead class="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-xs font-bold uppercase tracking-wider text-right text-slate-600 dark:text-slate-300">Sisa Hutang Nota</th>
